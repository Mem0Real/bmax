		...
		<div className="w-full px-4 xl:px-40 bg-neutral-100 text-neutral-950 pb-36">
			<div className="flex flex-col justify-center items-center gap-24 pt-28">
				...
				<div className="flex flex-col xl:flex-row justify-start items-start gap-4">
					<h1 className={`basis-1/3 text-6xl font-semibold ${raj.className}`}>
						ABOUT US_
					</h1>
				...
				<div className="flex flex-col justify-center items-start gap-8">
					<h1 className={`text-6xl font-semibold ${raj.className}`}>
						Why Choose B-Max?
					</h1>
					...
					<Link href="contact">
						<AnimatePresence>
							<motion.div
								...
								className={`w-fit py-4 xl:py-2 px-8 xl:px-6 border border-neutral-900 bg-neutral-900 text-white font-semibold uppercase text-nowrap ${raj.className}`}
							>
								HIRE US!
							</motion.div>
						</AnimatePresence>
