		...
		<div className="relative w-full flex flex-col">
			...
			<div className="relative bg-white text-neutral-900 py-12 flex flex-col justify-center items-center gap-6">
				...
				<div className="w-full flex flex-col justify-center items-center gap-2 md:gap-8 lg:gap-10 py-12">
					...
					<p className="px-6 xl:px-16 text-base text-neutral-950/90 w-[90%] md:w-[60%] lg:w-auto text-center">
				...
				<div className="w-full px-4 xl:px-40 flex justify-evenly items-start flex-wrap gap-y-12">
					<div className="flex flex-col justify-start items-center gap-8 max-w-[20rem] lg:min-w-[30rem] lg:max-w-[30rem] min-h-[35rem]">
						<div className="text-3xl md:text-5xl font-bold uppercase text-center self-center">
