...
const description = [
	{
		...
		image: "/images/landing-cards/car-key.webp",
		highlight: [
			"lost your car key",
	...
	},
	{
		...
		image: "/images/landing-cards/duplicate-key.webp",
		highlight: [
	...
	},
	{
		...
		address: "#",
		image: "/images/landing-cards/car-alarm-key.webp",
		highlight: [""],
	},
	{
		...
		image: "/images/landing-cards/ignition.webp",
		highlight: [""],
	},
	{
		...
		image: "/images/landing-cards/monitor.webp",
	...
	},
	{
		...
		address: "/ai-dashcam",
		image: "/images/landing-cards/protect.webp",
		highlight: [
			"vehicles",
			"cargo",
	...
	},
	{
		...
		image: "/images/landing-cards/fuel.webp",
	...
	},
	{
		...
		image: "/images/landing-cards/driver.webp",
		highlight: ["", "", ""],
	},
];
							...
							>
								...
								>
									<div className="self-start flex flex-col gap-2">
										<h2
											className={`text-sm md:text-lg lg:text-2xl font-bold whitespace-nowrap`}
										>
											{smallTitle}
										</h2>
										<h2
											className={`text-darkYellow text-xl md:text-3xl lg:text-5xl font-extrabold whitespace-nowrap ${raj.className}`}
										>
											{title}
										</h2>
									</div>
										...
										<motion.div className="relative w-[80%] h-[70vh] max-w-xl flex items-center justify-center aspect-[4/3]">
											...
											<motion.div className="w-full h-full relative overflow-hidden rounded-3xl">
												<Image
													src={image}
													alt={index}
													className="absolute object-contain object-center px-4 py-2 rounded-3xl"
													priority
													fill
