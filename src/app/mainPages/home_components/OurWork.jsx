...
export default function OurWork() {
	return (
		<div className="min-h-screen w-full px-12 xl:px-40 bg-neutral-950 text-neutral-100 flex flex-col justify-center items-center">
			<div className="w-full flex justify-stretch items-stretch relative">
				<h1 className="flex-1/4 text-6xl font-semibold capitalize pr-4 text-nowrap -mt-5">
					Our Work
				</h1>
				<div className="w-full flex-3/4 flex flex-col gap-36">
					<div className="flex">
						<div className="w-full">
							...
							<div className="w-full h-full flex flex-col justify-start items-start gap-6 pl-8">
								<h1 className="text-neutral-100 font-semibold text-lg pt-3">
									Automotive Locksmith Services
								</h1>
								<p className="text-neutral-200/50 pr-8 text-sm">
